/*
 * PTSolns Digit Display Library
 * Target: PTSolns 2x 4-Digit Display (I2Connect Series)
 * Driver: HT16K33A
 */

#ifndef PTSOLNS_I2CONNECT_DIGITDISPLAY_H
#define PTSOLNS_I2CONNECT_DIGITDISPLAY_H
...
class PTSolns_I2Connect_DigitDisplay {
  public:
    PTSolns_I2Connect_DigitDisplay();
